...
const routesUserAuth_js_1 = require("../../aplicacion/routes/routesUserAuth.js");
const routesProduct_js_1 = require("../../aplicacion/routes/routesProduct.js");
const routesClients_js_1 = require("../../aplicacion/routes/routesClients.js");
...
class Server {
    ...
    async DBconnection() {
        try {
            ...
            await user_js_1.User.sync({ alter: false });
